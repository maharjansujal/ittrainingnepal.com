...
import { corporate } from '@/app/utils/constants';
...
export default function CorporateDropdown() {
  ...
  const column1 = corporate.slice(0, 10); // First 10 items
  const column2 = corporate.slice(10);
    ...
    >
      ...
      <div
        className={`absolute top-[40px] left-0 bg-white shadow-lg rounded-md transform transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible'
          } z-10 w-auto min-w-[300px] max-w-[500px]`}
      >
